...
# Session 3.22 — silent-output guardrail. Near-empty students no longer
# receive full length/degeneracy/on-policy credit. Bump the schema so old v28
# composite rows are quarantined until regraded under the new scoring code.
